...
const StatsCard = ({ title, value, change, icon: Icon, trend = 'up' }) => {
    ...
    return (
        <div className="group bg-white p-5 md:p-7 rounded-[1.75rem] md:rounded-[2.5rem] border border-primary/10 shadow-2xl shadow-primary/[0.04] hover:border-primary/30 transition-all duration-500 hover:shadow-primary/10 relative overflow-hidden active:scale-[0.98] h-full flex flex-col justify-between">
