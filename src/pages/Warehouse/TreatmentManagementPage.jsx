...
import { Search, Plus, Trash2, Edit3, Activity, Filter, AlertTriangle, ChevronRight } from 'lucide-react';
                        ...
                        <tbody className="divide-y divide-primary/5">
                            {filteredTreatments.map((t) => (
                                <tr key={t.id} className="group hover:bg-primary/[0.02] transition-colors">
                                    ...
                                    <td className="px-8 py-6">
                                        <span className="px-3 py-1.5 rounded-xl bg-secondary border border-primary/5 text-[10px] font-black text-primary uppercase tracking-widest">{t.category}</span>
                                    </td>
