                        ...
                        <tbody className="divide-y divide-primary/5">
                            {filteredProducts.map((p) => (
                                <tr key={p.id} className="group hover:bg-primary/5 transition-colors">
                                    ...
                                    <td className="px-8 py-6">
                                        <span className={`font-black text-sm ${p.stock < 15 ? 'text-red-500' : 'text-primary'}`}>
                                            {p.stock}
                                        </span>
                                    </td>
            ...
            {deleteConfirm.open && createPortal(
                <div className="fixed inset-0 z-[110] flex items-center justify-center p-6 animate-fade-in">
                    ...
                    <div className="relative w-full max-w-sm bg-white rounded-[2.5rem] p-8 shadow-2xl border border-primary/5 text-center animate-fade-in-up">
                        ...
                        <p className="text-sm text-primary/40 font-bold mb-8">Yakin ingin menghapus <span className="text-primary">{deleteConfirm.name}</span>? Tindakan ini tidak bisa dibatalkan.</p>
