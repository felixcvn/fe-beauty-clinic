...
const MainLayout = ({ children }) => {
    ...
    return (
        <div className="flex min-h-screen bg-secondary-light">
            ...
            />
            <div className={`flex-1 min-w-0 flex flex-col min-h-screen relative z-10 transition-all duration-700 ease-in-out ${isDesktopCollapsed && !isHovered ? 'md:ml-[88px]' : 'ml-0 md:ml-64'}`}>
                <Header toggleSidebar={toggleSidebar} />
                <main className="flex-1 p-3.5 md:p-6 lg:p-8 overflow-y-auto overflow-x-hidden">
                    <div 
                        key={location.key}
